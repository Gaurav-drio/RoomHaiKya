...
- **Owner chat** — Message owners before you visit
- **Reviews & complaints** — Feedback loop for tenants and admins
...
SmartRoooms/
├── backend/
│   ├── data/         # users, rooms, bookings, chats (JSON)
│   ├── lib/auth.js   # Register, login, JWT
│   └── server.js
├── frontend/
│   └── src/
