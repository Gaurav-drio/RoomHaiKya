...
import {
  Users, Building2, AlertCircle, Home, FileText,
  BookOpen, Shield, ArrowRight, MessageSquare,
} from 'lucide-react';
...
const QUICK_LINKS = [
  ...
  { to: '/dashboard/admin/transactions', label: 'Activity', icon: BookOpen, color: 'bg-purple-500' },
  ...
  return (
    ...
    <DashboardLayout role="admin" title="Admin Control Center">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard label="Verified Listings" value={s.verifiedListings || 0} icon={Shield} color="purple" delay={0.35} />
