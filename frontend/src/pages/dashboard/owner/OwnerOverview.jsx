...
import { Home, Star, BookOpen, ArrowRight, UserCircle, TrendingUp, MessageCircle } from 'lucide-react';
        ...
        <motion.div whileHover={{ scale: 1.02, y: -4 }}>
          <Link to="/post" className="dash-card glow-border group flex items-center gap-4 rounded-2xl bg-gradient-to-r from-brand-500 to-purple-600 p-6 text-white shadow-xl">
            ...
            <div>
              ...
              <p className="text-sm text-white/80">List free — reach Jaipur students</p>
            </div>
