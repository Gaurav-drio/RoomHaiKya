...
export default function LoginPage() {
  ...
  return (
    ...
    <AuthShell
      ...
      sideTitle="Room Hai Kya"

      sidePoints={[

        'Chat with owners — no direct rent booking online',

        'Contact Now via Room Hai Kya verified helpline',

        'Verified listings across Jaipur',

        'Free owner listings forever',
      ...
      footer={
        ...
        <div className="mt-8 space-y-4 border-t border-gray-100 pt-6">
          ...
          <p className="rounded-xl bg-gray-50 px-4 py-3 text-center text-xs text-gray-500">
            ...
            Demo admin: <span className="font-mono text-gray-700">admin@roomhaikya.in</span> / <span className="font-mono text-gray-700">admin12345</span>
