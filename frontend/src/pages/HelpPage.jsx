...
const FAQ = [
  ...
  { q: 'How do I contact an owner?', a: 'Open any listing and use Chat or Contact Now. Conversations stay in your Messages inbox.' },
  ...
  { q: 'How to find a room partner?', a: 'Go to Dashboard → Room Partner to post your roommate profile.' },
  { q: 'How do reviews work?', a: 'Tenants and owners can leave reviews from their dashboard after interacting with a listing.' },
];
