      ...
      <section className="relative min-h-[90vh] overflow-hidden px-4 pb-20 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center">
            ...
            >
              Verified PGs, hostels & flats across Malviya Nagar, Mansarovar, Vaishali Nagar & more — chat with owners and rent with zero brokerage.
            </motion.p>
          </div>
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl text-white">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {[
              { step: '01', title: 'Create Account', desc: 'Sign up as owner in under a minute — free forever.' },
