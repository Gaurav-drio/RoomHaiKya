...
const SECTIONS = [
  { heading: 'Information We Collect', content: 'Name, email, phone number, college, preferred Jaipur area, role (tenant/owner), property preferences, and usage data when you browse listings or chat with owners.' },
  { heading: 'How We Use Your Data', content: 'To match tenants with owners, display your profile to relevant users, send booking notifications, and improve our Jaipur-focused marketplace.' },
  ...
  { heading: 'Cookies & Analytics', content: 'We use local storage for auth tokens. Analytics help us understand popular areas and listing types in Jaipur.' },
