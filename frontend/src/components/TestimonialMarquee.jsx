...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    text: 'Found a safe girls PG in Mansarovar in under 10 minutes. Chat with the owner was clear and booking felt safe.',
  },
  {
  ...
  },
  {
    ...
    text: 'Real photos, real prices, zero hidden charges. Chatted with owners and picked the best PG in Mansarovar.',
  },
  {
    name: 'Kavita Rathore',
  ...
  },
  {
    ...
    text: 'My hostel stays full because students trust SmartRoooms over random Facebook posts. Verified listings keep enquiries genuine.',
  },
  {
    name: 'Neha Agarwal',
  ...
  },
  {
    ...
    text: 'Owner chat and verified photos made house hunting near Manipal so much easier. Best student platform I have used in Rajasthan.',
  },
];
...
export function TrustStrip() {
  const items = [
    '✓ Zero Brokerage Forever', '✓ Owner-Posted Listings', '✓ In-App Owner Chat',
    '✓ Room Partner Matching', '✓ Admin-Verified Support', '✓ Reviews & Complaints',
    '✓ Jaipur Only — 12+ Areas', '✓ Boys & Girls PG', '✓ Previous Tenant Connect',
    '✓ Free Owner Listings', '✓ Post Requirements', '✓ Student-First Platform',
  ];
