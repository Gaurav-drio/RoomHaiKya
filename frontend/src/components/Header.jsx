...
import {
  ...
  FileText, Users, ChevronDown, Building2, Heart,
                    ...
                    <div className="absolute right-0 top-[calc(100%+8px)] z-50">
                      <NavDropdownPanel
                        menu={{
                          ...
                          description: `${user.role} account · Room Hai Kya`,
                          items: [
                            { to: profilePath, label: 'My Profile', desc: 'Edit name, phone & details', icon: Settings, color: 'from-brand-100 to-cyan-50' },
                            { to: dashPath, label: 'Dashboard', desc: 'Listings, chat & more', icon: LayoutDashboard, color: 'from-violet-100 to-purple-50' },
                          ],
