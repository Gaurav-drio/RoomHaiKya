...
import {
  X, MapPin, Building2, Users, Shield,
  GraduationCap, Phone, Mail, ArrowRight, Sparkles, MessageCircle,
} from 'lucide-react';
...
const HIGHLIGHTS = [
  ...
  { icon: MessageCircle, label: 'Owner Chat', desc: 'Message landlords before you visit any property' },
  { icon: Building2, label: 'Free Listings', desc: 'Owners post PGs & flats at zero cost forever' },
              ...
              <div className="mx-auto flex max-w-7xl items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/85 sm:text-base">
                    ...
                    across Jaipur — with zero brokerage, room partner matching, in-app owner chat, and
