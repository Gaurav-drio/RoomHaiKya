...
const TENANT_PERKS = [
  ...
  { icon: Search, title: 'Filter what you need', desc: 'Browse by area, budget, PG type & amenities across Jaipur.' },
  { icon: Star, title: 'Reviews you can trust', desc: 'Read and leave reviews so the next student chooses better.' },
];
